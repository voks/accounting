...
<form class="searchSJ-form">
	...
	<div class="row margin-top-5">
		<div class="col-md-3">
			<a id="btn_sales_export" class="btn btn-style-1 animate-4"><i class="fa fa-download"></i> Detailed Report &nbsp;</a>
		</div>
	</div>
	<div class="row margin-top-5">
		<div class="col-md-2">
			<a id="btn_sales_export_sum" class="btn btn-style-1 animate-4"><i class="fa fa-download"></i> Summary Report</a>
		</div>
	</div>
</form>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-offset-1 col-md-9">
						...
						<span class="txt">Location:<br/>C:\xampp\htdocs\accounting\Reports\Sales_Journal\</span>
					</div>
				</div>
				<div class="modal-footer">
