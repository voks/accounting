<form class="cd-form">
	...
	<div class="row">
		...
		<div class="col-md-2">
			...
			<input type="text" class="form-control" value="<?=$transdata[0]->cd_released?>">
		</div>
		<div class="col-md-3">
			<span class="txt">Released Date:</span>
			<input type="text" class="form-control datepicker" value="<?=$transdata[0]->cd_released_date?>">
		</div>
	</div>
	<!-- Third Row -->
	<div class="row">
		<div class="col-md-3">
			...
			<input type="text" class="form-control" value="<?=$transdata[0]->cd_cleared?>">
		</div>
		<div class="col-md-4">
			<span class="txt">Cleared Date:</span>
			<input type="text" class="form-control datepicker" value="<?=$transdata[0]->cd_cleared_date?>">
		</div>
		<div class="col-md-5">
			<span class="txt">Check Amount:</span>
			<input type="text" readonly="true" class="form-control" value="<?=number_format($transdata[0]->cd_check_amount,2)?>">
		</div>
	</div>
	<!-- Fourth Row -->
	<div class="row">
