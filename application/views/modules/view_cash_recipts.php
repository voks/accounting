<form class="cr-form">
	...
	<div class="row">
		...
		<div class="col-md-2">
			...
			<input type="text" readonly="true" class="form-control" value="<?=$transdata[0]->cr_cleared?>">
		</div>
		<div class="col-md-2">
			<span class="txt">Date Cleared:</span>
			<input type="text" readonly="true" class="form-control" value="<?=$transdata[0]->cr_cleared_date?>">
		</div>
		<div class="col-md-3">
			<span class="txt">OR Amount:</span>
			<input type="text" readonly="true" class="form-control" value="<?=$transdata[0]->cr_or_amount?>">
		</div>
	</div>
	<!-- Third Row -->
	<div class="row">
